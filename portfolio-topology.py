...
class PortfolioNetwork2410(Topo):
    ...
    def build(self, **_opts):
        ...
        self.addLink(r2, h7, intfName1='r2-eth1', params1={'ip': '10.0.2.1/24'})
        ...
        self.addLink(r3, h8, intfName1='r3-eth1', params1={'ip': '10.0.4.1/24'})
        ...
        for h in (h4, h5, h6):
            self.addLink(h, s2)
        self.addLink(s2, r3, intfName2='r3-eth2', params2={'ip': '10.0.5.1/24'})
        ...
        self.addLink(r4, h9, intfName1='r4-eth1', params1={'ip': '10.0.7.1/24'})
